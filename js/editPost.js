...
function loadValues(){
  allAddress=[];
  allAddress.push("Heinrichstraße 5, 01097 Dresden, Alemanha"); //start;
  allAddress.push("Terrassenufer 4, 01067 Dresden, Alemanha"); //end
  allAddress.push("Palaispl. 11, 01097 Dresden, Alemanha");
  allAddress.push("Augustusbrücke, 01097 Dresden, Alemanha");
  allAddress.push("Theaterplatz 2, 01067 Dresden, Alemanha");
  allAddress.push("Postpl. 1, 01067 Dresden, Alemanha");
  allAddress.push("Taschenberg 2, 01067 Dresden,Alemanha");
  allAddress.push("Alemanha,Rampische Str. 6, 01067 Dresden, Alemanha");
